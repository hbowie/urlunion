...
public class ReplaceWindow 
  ...
  public ReplaceWindow(URLMainFrame mainFrame) {
    initComponents();
  ...
  public void noFindInProgress() {
    setFindButtonText(URLMainFrame.FIND);
    replaceButton.setEnabled(false);
    replaceAndFindButton.setEnabled(false);
  }
  
  public void findInProgress() {
    setFindButtonText(URLMainFrame.FIND_AGAIN);
  ...
  private void replace() {
    mainFrame.replaceURL(findTextField.getText(), replaceTextField.getText(),
        titleSelected(),
        urlSelected(),
        tagsSelected(),
        commentsSelected());
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        getContentPane().add(urlCheckBox, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        getContentPane().add(commentsCheckBox, gridBagConstraints);
